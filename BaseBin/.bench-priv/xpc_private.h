...
#endif
#ifndef BENCH_XPC_EXTRAS
#define BENCH_XPC_EXTRAS
#include <mach/mach.h>
xpc_connection_t xpc_dictionary_copy_mach_send(xpc_object_t xdict, const char *name);
void xpc_dictionary_set_mach_send(xpc_object_t xdict, const char *name, mach_port_t port);
#endif
